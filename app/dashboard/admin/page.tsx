    ...
    <div className="min-w-0 max-w-full space-y-8">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-3xl font-bold dark:text-zinc-100 text-gray-900">Dashboard</h1>
          <p className="dark:text-zinc-400 text-gray-900 mt-1">Panel de control Master Admin</p>
        </div>
      ...
      {/* Clients Table */}
      <div>
        <h2 className="text-xl font-bold text-black dark:text-zinc-100 mb-4">Todos los Clientes</h2>
