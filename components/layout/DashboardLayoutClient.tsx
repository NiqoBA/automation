...
export default function DashboardLayoutClient({
  ...
  const sidebarWidth = sidebarCollapsed ? 64 : 224 // w-16 = 64px, w-56 = 224px
  const mainPadding = sidebarCollapsed ? 64 : 224

  return (
    <div className={`min-h-screen flex overflow-x-hidden transition-colors duration-200 ${
      theme === 'light' 
      ...
      >
        <div className={`flex flex-col flex-grow transition-colors duration-200 ${
          theme === 'light'
            ? 'bg-white border-r border-gray-200'
            : 'bg-zinc-900 border-r border-zinc-800'
        }`}>
          {/* Logo */}
          <div className={`flex items-center flex-shrink-0 px-4 py-4 border-b transition-colors duration-200 ${
          ...
          <div className="flex-grow flex flex-col overflow-y-auto">
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    className={`flex items-center ${sidebarCollapsed ? 'justify-center' : 'justify-between'} gap-2 px-3 py-2 rounded-lg transition-all duration-150 ${
                      isActive
                        ? theme === 'light'
            ...
            {/* Theme Toggle */}
            <div className={`px-2 py-2 border-t transition-colors duration-200 ${
              theme === 'light' ? 'border-gray-200' : 'border-zinc-800'
            }`}>
              <button
                onClick={toggleTheme}
                className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center' : 'justify-start'} gap-2 px-3 py-2 rounded-lg transition-colors ${
                  theme === 'light'
            ...
            <div className={`px-2 py-2 border-t transition-colors duration-200 ${
              ...
              {!sidebarCollapsed ? (
                <>
                  <div className={`px-3 py-2 rounded-lg mb-2 transition-colors duration-200 ${
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          />
          <div className={`fixed inset-y-0 left-0 w-64 transition-colors duration-200 ${
            theme === 'light' ? 'bg-white border-r border-gray-200' : 'bg-zinc-900 border-r border-zinc-800'
          }`}>
      ...
      >
        {/* Mobile header */}
        <div className={`md:hidden flex items-center justify-between gap-4 px-4 py-3 border-b transition-colors duration-200 ${
          ...
          <button
            ...
            className={`p-2 flex-shrink-0 rounded-lg transition-colors ${
              theme === 'light' ? 'hover:bg-gray-100 text-gray-600' : 'hover:bg-zinc-800 text-zinc-400'
            }`}
          >
        ...
        {/* Page content */}
        <main className={`p-4 md:p-6 overflow-x-auto min-w-0 transition-colors duration-200 ${
